...
export default function Curation() {
  ...
  return (
    <div className="w-full bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 h-full flex flex-col overflow-hidden">
      ...
      {error && (
        <div className="mb-3 p-2 bg-red-100 dark:bg-red-900/30 border border-red-200 dark:border-red-800 rounded-md text-red-600 dark:text-red-400 text-sm">
          {error}
        </div>
      )}
      ...
      <div className="flex-1 overflow-auto">
        {loading ? (
          ...
          <div className="text-center text-gray-500 dark:text-gray-400 py-4">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 mx-auto mb-2 text-lofi-300 dark:text-lofi-700" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
